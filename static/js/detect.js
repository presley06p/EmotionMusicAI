...
function renderFaceResult(data) {
  ...
  document.getElementById('faceMethodBadge').textContent = mock ? 'Demo' : 'FER';
...
function renderTextResult(data) {
  ...
  document.getElementById('textMethodBadge').textContent = method === 'transformer' ? 'Transformer' : 'NLP';
